...
const LoadingPage = () => {
  ...
  <section id="home" className="hero-bg min-h-screen flex items-center justify-center relative">
    ...
    {/* Floating Elements */}
    <div className="absolute top-20 left-10 text-4xl floating-animation" style={{animationDelay: '-1s'}}>🎭</div>
    <div className="absolute bottom-20 right-10 text-4xl floating-animation" style={{animationDelay: '-3s'}}>🍿</div>
